...
public class SearchCoinFragment extends AbsRefreshListFragment {
    ...
    public static SearchCoinFragment getInstance() {
        SearchCoinFragment fragment = new SearchCoinFragment();
