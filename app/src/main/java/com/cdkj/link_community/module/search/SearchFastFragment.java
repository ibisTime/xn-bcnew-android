...
public class SearchFastFragment extends AbsRefreshListFragment {
     ...
     * @return
     */
    public static SearchFastFragment getInstance() {
        SearchFastFragment fragment = new SearchFastFragment();
        return fragment;
    }
    ...
    public RecyclerView.Adapter getListAdapter(List listData) {
        ...
        FastMessageListAdapter fastMessageListAdapter = new FastMessageListAdapter(listData, false);
